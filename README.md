...
2. Abra os arquivos appsettings.json e appsettings.development.json e configure o seu usuário e senha do SQL Server na string de conexão.
...
1. Abra o console do gerenciador de pacotes do nuget no Visual Studio 2022
2. Selecione o projeto TaskManager.Infra.Data 
3. Rode o comando **Add-Migration DatabaseCreation**
